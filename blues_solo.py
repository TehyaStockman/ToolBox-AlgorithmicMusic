...
licks = [  [ [1,0.5], [1,0.5], [1, 0.5], [1, 0.5] ], [ [1, 0.5*1.1], [1, 0.5*0.9], [1, 0.5*1.1], [1, 0.5*0.9] ], 
[ [-1, 0.5], [-1, 0.5], [-1, 0.5], [-1, 0.5] ],[ [-1, 0.5*1.1], [-1, 0.5*0.9], [-1, 0.5*1.1], [-1, 0.5*0.9] ],[ [1, 0.5], [1, 0.5*1.1], [-1, 0.5*0.9], [1, 0.25], [0, 0.25] ] ]
for i in range(4):
    lick = choice(licks)
    for note in lick:
        if curr_note == 0:
            curr_note += abs(note[0])
